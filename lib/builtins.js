...
exports._stream_duplex = require.resolve('readable-stream').Duplex;
exports._stream_passthrough = require.resolve('readable-stream').PassThrough;
exports._stream_readable = require.resolve('readable-stream').Readable;
exports._stream_transform = require.resolve('readable-stream').Transform;
exports._stream_writable = require.resolve('readable-stream').Writable;
