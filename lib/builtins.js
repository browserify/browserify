...
exports.stream = exports['readable-stream'] = require.resolve('stream-browserify');
exports._stream_duplex = exports['readable-stream/duplex'] = require.resolve('stream-browserify/duplex.js');
exports._stream_passthrough = exports['readable-stream/passthrough']  = require.resolve('stream-browserify/passthrough.js');
exports._stream_readable = exports['readable-stream/readable'] = require.resolve('stream-browserify/readable.js');
exports._stream_transform = exports['readable-stream/transform']  = require.resolve('stream-browserify/transform.js');
exports._stream_writable = exports['readable-stream/writable']  = require.resolve('stream-browserify/writable.js');
