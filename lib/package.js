...
var Package = module.exports = function (pkgname, basedir, topPkg) {
    ...
    if (!topPkg) {
        ...
        if (typeof topPkg.browserify.base === 'string') {
            return Package(
                pkgname,
                path.resolve(basedir, topPkg.browserify.base),
                topPkg
            );
        }
        else if (Array.isArray(topPkg.browserify.base)) {
            return Package.merge(topPkg.browserify.base.map(function (name) {
                return Package(
                    pkgname,
